...
from utils import basis_vector_to_bitstring, bitstrings_to_optimized_portfolios, dicke_state_vector, hamming_weight_indices, int_to_bitstring, normalize_linear_combination, replace_h_rz_h_with_rx, smallest_eigenpairs, smallest_sparse_eigenpairs
...
class HigherOrderPortfolioQAOA:
    ...
    def solve_with_qaoa_cma_es(self):
        ...
        qaoa_circuit, qaoa_probs_circuit, layers_used, _ = self.build_integer_hubo_circuit()
    ...
    def construct_selection_hubo_bin(self, K):
        ...
        # construct_cost_hubo_int line 145, which disagrees with both).
        self.selection_K = K
